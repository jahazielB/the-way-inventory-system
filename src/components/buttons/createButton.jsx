...
export const CreateButton = () => {
  ...
  return (
    <button className="flex h-[40px] items-center gap-1 bg-[#0A84FF] text-white px-4 py-2 rounded-md hover:bg-[#0077e6] transition-colors active:scale-95" onClick={()=>navigate('/accounts/create')}>
