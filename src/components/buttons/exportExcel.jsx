export const ExportExcelButton = ({perPageStyle,textHiddenMobile})=>{
    ...
    return <button className={`${baseStyle} ${perPageStyle}`}>
            ...
            <span className={`${textHiddenMobile}`}>Export Excel</span> 
        </button>
}