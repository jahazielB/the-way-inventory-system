...
export const SearchBar = () => {
  return (
    <div className="flex items-center h-[40px] w-[300px] max-w-sm rounded-[10px] border border-gray-300 px-3 py-1 bg-white">
      ...
      <input
        type="text"
        placeholder="Search"
        className="ml-2 w-full border-none outline-none text-gray-700 placeholder-gray-400"
      />
    </div>
  );
};
