      ...
      <div className={`h-full z-[1300]  w-54 md:w-[256px]  transform transition-transform duration-300 md:min-h-screen bg-white text-[rgba(0,0,255,90)] max-lg:fixed flex flex-col
        ...
        <div>
          ...
          <div className="relative p-4 pb-20  ">
            <img src="/word.png" className="absolute inset-0 z-0 opacity-80 mx-auto pointer-events-none" alt="" />
          </div>

          {/* Menu */}
          <nav className="mt-8 ml-2 md:ml-0">
            <ul className="space-y-1.5 ">
              <li className={`dashboard-menu  text-[15px] md:text-[20px]  ${location.pathname === '/dashboard'&&'bg-gray-300 font-black'}`}  onClick={()=>temporaryHandleClick('dashboard')}>
