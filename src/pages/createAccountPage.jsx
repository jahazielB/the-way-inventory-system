    ...
    return (
        ...
        <div className="flex gap-1 ">
                ...
                <div className="flex flex-col ml-[5%] md:mx-[9%] lg:mx-[15%] xl:mx-[10%] max-md:gap-4 gap-4 p-4">
                    ...
                    <span className="text-center text-[42px] font-medium">Create Account</span>
                    <div className="w-[clamp(200px,50vw,533px)] aspect-[533/467] bg-white rounded-2xl flex flex-col p-8 gap-3.5">
                        ...
                        <button className="w-[clamp(150px,50vw,472px)] aspect-[472/65]  bg-blue-600 rounded-2xl text-white hover:bg-[rgba(37,99,235,.8)] active:bg-[rgba(12,51,137,0.8)] active:scale-99">Create Account</button>
                    </div>
