  ...
  return (
    <div className="p-0">
      ...
      <div className="h-[61px] max-w-full  bg-white pt-[5px] mt-[80px] relative">
        <img
          className="absolute -top-[25px] lg:-top-[65px] left-1/2 -translate-x-1/2 sm:w-[180px] h-[150px] w-[150px] md:h-[185px] z-10"
          src="/TheWayLogo.png"
          alt=""
        />
      </div>
        ...
        <div className=" h-[300px] w-[285px] bg-white shadow-2xl rounded-3xl p-10">
          ...
          >
            <div className="flex w-[197px] h-[32px] border rounded-[10px] border-[rgba(1,24,216,1)] p-1.5 gap-2">
              <svg
                className="h-[18px] w-[18] text-[rgba(1,24,216,1)]"
                fill="currentColor"
              ...
              <input
                className="w-[150px] h-[17px] outline-0"
                type="email"
                name="email"
                placeholder="email"
                required
      ...
      {/* svg bg's */}
      <svg
        className="transform absolute top-0 p-0 -z-10 right-0 h-screen
         "
        viewBox="0 0 251 1024"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
          d="M1147 474.881C1147 806.252 890.235 1074.88 573.5 1074.88C256.765 1074.88 0 806.252 0 474.881C0
         143.51 256.765 -125.119 573.5 -125.119C890.235 -125.119 1147 143.51 1147 474.881Z"
          fill="#0118D8"
        />
        <path
          d="M1216 384.5C1216 690.19 959.235 938 642.5 938C325.765 938 69 690.19 69 384.5C69 78.8104 325.765 -169 642.5 
        -169C959.235 -169 1216 78.8104 1216 384.5Z"
          fill="#1B56FD"
        />
      </svg>
      <svg
        className="transform absolute  bottom-0  p-0  -z-10 left-0 h-screen max-sm:hidden"
        height="100"
        viewBox="0 0 231 778"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
          d="M-916 643.881C-916 975.252 -659.235 1243.88 -342.5 1243.88C-25.7647 1243.88 231 975.252 231 643.881C231 312.51 -25.7647 43.8813 -342.5 43.8813C-659.235 43.8813 -916 312.51 -916 643.881Z"
          fill="#0118D8"
        />
        <path
          d="M-985 553.5C-985 859.19 -728.235 1107 -411.5 1107C-94.7647 1107 162 859.19 162 553.5C162 247.81 -94.7647 1.97551e-06 -411.5 1.97551e-06C-728.235 1.97551e-06 -985 247.81 -985 553.5Z"
          fill="#1B56FD"
        />
      </svg>
    </div>
