            ...
            <div className=" h-[300px] w-[285px] bg-white shadow-2xl rounded-3xl p-10">
                <form className="flex flex-col gap-6" action="" method="post">
                    <div className="flex w-[197px] h-[32px] border rounded-[10px] border-[rgba(1,24,216,1)] p-1.5 gap-2">
                        ...
                        <input className="w-[150px] h-[17px] outline-0" type="text" name="username" placeholder="username" required />
                    </div>
                    <div className="flex w-[197px] h-[32px]  border rounded-[10px] border-[rgba(1,24,216,1)] p-1.5 gap-2 ">
                        ...
                        <input className="w-[150px] h-[17px] border-0 outline-0" type="text" name="password" placeholder="password" required />
                    </div>
